...
export const ProjectTypeSection = () => {
  return (
    <section className="flex flex-wrap gap-5 justify-between px-7 py-4 mt-6 w-full rounded-xl border border-solid border-slate-200 shadow-[0px_1px_2px_rgba(0,0,0,0.05)] max-md:px-5">
      ...
      <div className="flex gap-2.5 items-center py-1 pr-1 pl-7 my-auto bg-sky-200 min-h-[25px] rounded-[100px] max-md:pl-5">
        <div className="flex self-stretch my-auto w-5 h-5 bg-teal-500 rounded-full min-h-5" />
      </div>
    </section>
  );
};

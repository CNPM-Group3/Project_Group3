        ...
        public async Task<AuthResponse> HandleGoogleCallbackAsync(string code, string action)
        {
            try
            {
                ...
                if (tokenResponse == null)
                {
                    ...
                    return new AuthResponse { Success = false, Message = "Đăng nhập thất bại. Vui lòng thử lại." };
                }
                ...
                if (userInfo == null)
                {
                    ...
                    return new AuthResponse { Success = false, Message = "Lỗi khi đăng nhập bằng Google. Vui lòng thử lại." };
                }
